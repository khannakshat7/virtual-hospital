...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  var a = Math.PI / 180,
    ...
    j = function (a) {
      var b,
        ...
        w = 2,
        x = 0;
      if (!a || !isNaN(r[0]) || isNaN(r[1]))
        return g("ERROR: malformed path data: " + a), s;
      for (b = 0; v > b; b++)
        if (
          ((q = h),
          isNaN(r[b]) ? ((h = r[b].toUpperCase()), (j = h !== r[b])) : b--,
          (e = +r[b + 1]),
          (f = +r[b + 2]),
          j && ((e += t), (f += u)),
          0 === b && ((l = e), (m = f)),
          ...
          "Z" === h && ((e = l), (f = m), (k.closed = !0)),
            ("L" === h || Math.abs(t - e) > 1 || Math.abs(u - f) > 1) &&
              ((k[w++] = t + (e - t) / 3),
              (k[w++] = u + (f - u) / 3),
              (k[w++] = t + (2 * (e - t)) / 3),
              (k[w++] = u + (2 * (f - u)) / 3),
    ...
    t = function (a, b, c) {
      ...
      if (c)
        for (d = a.slice(0), m(d), f = 6; g > f; f += 6)
    ...
    v = function (a, b, c) {
      var d,
        ...
        h = b.length,
        i = 0,
        j = 0.8 * (b[c].size || o(b[c])),
        k = 999999999999,
        l = a.size || o(a),
        m = a.centerX,
        n = a.centerY;
      for (d = c; h > d && ((l = b[d].size || o(b[d])), !(j > l)); d++)
        (e = b[d].centerX - m),
          (f = b[d].centerY - n),
          (g = Math.sqrt(e * e + f * f)),
          k > g && ((i = d), (k = g));
    ...
    w = function (a, b, c, d) {
      ...
      if (n[0]) {
        if (j) {
          ...
          for (
            l[0].length > n[0].length &&
              k(n[0], ((l[0].length - n[0].length) / 6) | 0),
              w = n.length;
            j > o;
        ...
        for (w = 0; w < a.length; w++)
          (e = b[w]),
            (f = a[w]),
            (j = e.length - f.length),
            0 > j ? k(e, (-j / 6) | 0) : j > 0 && k(f, (j / 6) | 0),
            y && !f.reversed && m(f),
            (c = x[w] || 0 === x[w] ? x[w] : "auto"),
            c &&
              (f.closed ||
    ...
    E = function (a, b) {
      ...
      return "path" !== y && a.getBBox
        ? ((i = D(a, "x,y,width,height,cx,cy,rx,ry,r,x1,x2,y1,y2,points")),
          "rect" === y
    ...
    F = function (a, b) {
      var c, e;
      return (
        ("string" != typeof a || (a.match(d) || []).length < 3) &&
          ((c = f.selector(a)),
          c && c[0]
            ? ((c = c[0]),
              (e = c.nodeName.toUpperCase()),
              b && "PATH" !== e && ((c = E(c, !1)), (e = "PATH")),
              (a = c.getAttribute("PATH" === e ? "d" : "points") || ""))
            : (g("WARNING: invalid morph to: " + a), (a = !1))),
        a
      );
    },
    G =
      ...
      init: function (a, b, c) {
        ...
        return "function" != typeof a.setAttribute
          ...
          : ((d = a.nodeName.toUpperCase()),
            ...
            "PATH" === d || j
              ? ((f = "PATH" === d ? "d" : "points"),
                ("string" == typeof b || b.getBBox) && (b = { shape: b }),
                (i = F(b.shape || b.d || b.points || "", "d" === f)),
                j && e.test(i)
                  ? (g("WARNING: a <" + d + "> cannot accept path data. " + G),
                    !1)
                  : (i &&
                      ((this._target = a),
                      (h = this._addTween(
                        ...
                        !1,
                        f,
                        "d" === f ? y(b.shapeIndex, b.map) : C(b.shapeIndex)
                      )),
                      h &&
                        ...
                        (h.endProp = f))),
                    !0))
              : (g("WARNING: cannot morph a <" + d + "> SVG element. " + G),
                !1));
      },
      set: function (a) {
        var b;
  ...
  (H.pathFilter = x),
    (H.pointsFilter = B),
    (H.subdivideRawBezier = k),
    (H.pathDataToRawBezier = function (a) {
      return j(F(a, !0));
    }),
    (H.equalizeSegmentQuantity = w),
    (H.convertToPath = function (a, b) {
    ...
    (H.pathDataToBezier = function (a, b) {
      ...
      if (((b = b || {}), (f = b.matrix), (c = []), (e = i.length), f))
        for (
          b.relative && ((f = f.slice(0)), (f[4] -= i[0]), (f[5] -= i[1])),
            d = 0;
          e > d;
          d += 2
        )
